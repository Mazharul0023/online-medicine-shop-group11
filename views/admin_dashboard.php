...
<style>
        ...
        .dashboard-container { max-width: 1000px; margin: auto; background: white; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1); }
        ...
        .btn { padding: 8px 12px; text-decoration: none; border-radius: 4px; font-weight: bold; }
...
<?php endwhile; ?>
<?php else: ?>
<tr><td colspan="6" align="center">No medicines found!</td></tr>
<?php endif; ?>
</tbody>
</table>
</div>
